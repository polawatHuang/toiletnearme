...
import { MagnifyingGlassIcon, MapPinIcon, ArrowPathIcon } from '@heroicons/react/24/outline';
import ToiletCard from '@/components/ToiletCard';

export default function ToiletSidebar({ toilets, selected, loading, onSelect, onNearMe, onSearch, searchValue, setSearchValue }) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-slate-100">
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 mb-3">
          ...
          <button type="submit" className="px-3 py-2 rounded-xl bg-brand-500 text-white text-sm hover:bg-brand-600 transition">
            ค้นหา
          </button>
        </form>
